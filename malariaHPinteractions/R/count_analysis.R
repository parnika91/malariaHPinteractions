...
>>>>>>> 47159c7b18c3ff19da0eedf0f90173fe3f405b13
...
write.table(table_output, paste0("table_",study,".txt", collapse=''), row.names=TRUE, sep="\t")
write.table(hp_percent, paste0("/SAN/Plasmo_compare/SRAdb/Output/", study, "/hp_percent_",study,".txt", collapse=''), row.names=FALSE, sep="\t")
