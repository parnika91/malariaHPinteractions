...
colnames(allHPexpression) <- c("RunID", "Study", "Host", "Host_percent", "Parasite", "Parasite_percent", "CountSum", "InputReads",  "MapPercent" ,"HostParasite", "HostSum", "ParasiteSum", "MultipleMapReads", "UnmappedReads", "ActualParasite", "ActualHost")
```
...
allHPexpression <- read.delim("/SAN/Plasmo_compare/SRAdb/allHPexpression.txt")
...
```
\newpage
Plot 9. Correlation between CountSum (total count given by countOverlaps() for a run) and InputReads (total number of input reads for a run)
