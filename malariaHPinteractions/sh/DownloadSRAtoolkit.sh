...
/SAN/Plasmo_compare/SRAdb/sratoolkit.2.8.2-1-ubuntu64/bin/fastq-dump -I --split-3 $fastq -O /SAN/Plasmo_compare/fastq_download_tmp/


#/SAN/Plasmo_compare/SRAdb/sratoolkit.2.8.2-1-ubuntu64/bin/fastq-dump --split-3 $fastq -O /SAN/Plasmo_compare/fastq_download_tmp/
# remove -I and do fastq-dump --split-files for bwa
