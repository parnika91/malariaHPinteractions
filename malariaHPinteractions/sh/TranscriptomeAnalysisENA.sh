...
parallel --eta -j 2 --link bash --verbose /SAN/Plasmo_compare/SRAdb/Scripts/malariaHPinteractions/sh/doallENA.sh ::: $(cat /SAN/Plasmo_compare/SRAdb/Output/$studyID/runs.txt)
